...
public class RegCarBrandView extends javax.swing.JFrame {
    public RegCarBrandView() {
        initComponents();
    }
    ...
    public String getjTxtBrandName() {
        return jTxtBrandName.getText();
    }
    ...
    private void initComponents() {
        ...
        jTxtBrandName.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTxtBrandNameActionPerformed(evt);
            }
        });
    ...
    private void jTxtBrandNameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTxtBrandNameActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTxtBrandNameActionPerformed
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegCarBrandView().setVisible(true);
            }
        });
    }
