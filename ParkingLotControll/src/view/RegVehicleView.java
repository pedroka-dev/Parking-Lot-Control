...
public class RegVehicleView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboOwner.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "None" }));
        jComboOwner.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jComboOwnerActionPerformed(evt);
            }
        });
        ...
        jLabel10.setText("Vehicle's Version:");

        jComboCarVersion.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "None" }));
    ...
    private void jComboOwnerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboOwnerActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jComboOwnerActionPerformed
