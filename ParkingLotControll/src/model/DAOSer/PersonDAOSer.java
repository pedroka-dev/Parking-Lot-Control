...
public class PersonDAOSer implements InterfaceDAOSer<Person> {
    ...
    public static final String archiveSerialization = ".\\SerializePerson.ser";
    ...
    public void Delete(int id) {
        ...
        try {
                listPerson = serialize.DeSerialize(archiveSerialization);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
        ...
        try {
            serialize.Serialize(archiveSerialization, (ArrayList) listPerson);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
